...
def write_to_s3_bronze(spark_session, schema, bucket_name, source_zone, target_zone, output_format, output_mode):
    ...
    write_to_s3(bronze_df, bucket_name, target_zone, output_format, output_mode)
