...
def write_to_s3_raw(spark_session, bucket_name, source_zone, target_zone, output_format, output_mode):
    ...
    write_to_s3(df_with_schema, bucket_name, target_zone, output_format, output_mode)
